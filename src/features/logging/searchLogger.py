...
class SearchLogger:
    ...
    def log_output(self, quality, archive, archive_fitness, population, population_fitness, wrapper_duration, archive_duration):
        self.output_quality_logger.log(quality, wrapper_duration, archive_duration)
