...
class OutputQualityLogger:
    ...
    def log(self, final_solution_quality, wrapper_duration, archive_duration):
        if not self.metrics:
            self.metrics = list(final_solution_quality.keys())
            self.metrics.append('wrapper_duration')
            self.metrics.append('archive_duration')
        self.results = list(final_solution_quality.values())
        self.results.append(wrapper_duration)
        self.results.append(archive_duration)
