    ...
    def search(self, experiment_name, fitness_function, initial_population):
        ...
        for idx, candidate in enumerate(population):
            ...
            if not any(binary_population[idx]):
                ...
                archive[spent_nfes] = copy.deepcopy(binary_population[idx])
                archive_fitness[spent_nfes] = population_fitness[idx]
        ...
        while spent_nfes < self.max_nfes:
            ...
            for idx, binaryTrialCandidate in enumerate(binary_trial_population):
                ...
                archive[spent_nfes] = copy.deepcopy(binary_trial_population[idx])
                archive_fitness[spent_nfes] = trial_population_fitness[idx]
